...
fputcsv($output, array('Transaction ID', 'Item Name', 'Category Name', 'Sale Amount', 'Restock Amount', 'Overall' ,'Time Stamp'));

// fetch the data
$sql = "SELECT s.sale_id, i.item_name, c.category_name, s.sale_count, s.sale_date
				FROM items i
...
$sql = "SELECT r.restock_id, i.item_name, c.category_name, r.restock_count, r.restock_date
				FROM items i
